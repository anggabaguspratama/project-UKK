...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="../maskapai/index.php"><i class="fa fa-plane"></i> <span>Maskapai</span></a></li>
      ...
      <div class="box-header">
        ...
        <form action="index.php" method="get">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <input type="text" class="form-control" name="caridari" placeholder="keberangkatan" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <input type="text" class="form-control" name="caritujuan" placeholder="Tujuan" required>
              </div>
            </div>
          </div>
          <div class="row">
      ...
      <div class="box-body no-padding">
        <table class="table table-striped">
          ...
          if(isset($_GET['caridari'])){
            ...
            $data = mysql_query("SELECT * from rute where dari = '".$caridari."' AND tujuan = '".$caritujuan."' ORDER BY harga");       
          }
          else{
            $data = mysql_query("SELECT * from rute");   
          }
          ...
          while($d = mysql_fetch_array($data)){
            ...
            <tr>
              ...
              <td><?php echo "<a href='delete.php?id=$d[id]'>Delete</a>"; ?></td>
              <td><?php echo "<a href='edit.php?id=$d[id]'>Edit</a>"; ?></td>
            </tr>
            <?php } ?>
          </table>
        </div>
